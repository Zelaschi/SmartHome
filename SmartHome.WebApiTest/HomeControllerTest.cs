...
public class HomeControllerTest
{
    ...
    public void CreateHomeTest_Ok()
    {
        ...
        homeLogicMock.Setup(h => h.CreateHome(It.IsAny<Home>(), It.IsAny<Guid>()))
            .Returns(home);
        ...
        Assert.AreEqual(expectedDeviceResult.StatusCode, result.StatusCode);
        Assert.AreEqual(expectedResult, homeResult);
    }
    ...
    public void GetAllHomeMembersTest_Ok()
    {
        ...
        homeLogicMock.Setup(h => h.GetAllHomeMembers(home.Id))
            .Returns(homeMembers);
        ...
        homeLogicMock.VerifyAll();
        Assert.AreEqual(result.StatusCode, expected.StatusCode);
        Assert.AreEqual(expectedObject.First().HomeMemberId, objectResult.First().HomeMemberId);
    }
    ...
    public void GetAllHomeDevicesTest_Ok()
    {
        ...
        homeLogicMock.Setup(h => h.GetAllHomeDevices(home1.Id, null))
            .Returns(homeDevices);
        ...
        homeLogicMock.VerifyAll();
        Assert.AreEqual(result.StatusCode, expected.StatusCode);
        Assert.AreEqual(expectedObject.First().HardwardId, objectResult.First().HardwardId);
    }
    ...
    public void GetAllHomeDevices_WithRoomFilter_ReturnsFilteredDevices()
    {
        ...
        var list = new List<HomeDevice>
        {
            device1
        };

        homeLogicMock.Setup(h => h.GetAllHomeDevices(home.Id, room.Name))
            .Returns(list);
    ...
    public void UnRelatedHomeOwnersTest_Ok()
    {
        ...
        homeLogicMock.Setup(h => h.UnRelatedHomeOwners(home.Id))
    ...
    public void TurnOnOffHomeDevice_ValidDevice_ReturnsUpdatedState()
    {
        ...
        homeLogicMock.Setup(h => h.TurnOnOffHomeDevice(homeDeviceId))
    ...
    public void GetHomeByIdTest_Ok()
    {
        ...
        homeLogicMock.Setup(h => h.GetHomeById(home.Id))
            .Returns(home);
    ...
    public void GetHomeById_HomeIdMissing_Test_ReturnsNotFound()
    {
        ...
        homeLogicMock.Setup(h => h.GetHomeById(missingHomeId))
            .Returns((Home)null);
