...
namespace SmartHome.DataAccess.Migrations
{
    ...
    [Migration("20241112184027_ModelValidatorTable")]
    partial class ModelValidatorTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.ModelNumberValidator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 11, 12, 15, 40, 24, 339, DateTimeKind.Local).AddTicks(8586),
